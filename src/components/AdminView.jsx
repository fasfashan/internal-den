  ...
  return (
    <>
        ...
        {photos.length > 0 ? (
          <div className="grid grid-cols-2 gap-1 p-1">
            {photos.map((photo, i) => (
              ...
              >
                <img src={photo} alt={`${label} ${i + 1}`} className="w-full h-24 object-cover transition-transform group-hover:scale-105" />
      ...
      {lightboxIndex !== null && (
        ...
        >
          {/* Counter */}
          <span className="absolute top-5 left-1/2 -translate-x-1/2 text-white/50 text-xs font-medium tracking-wide">
          ...
          {photos.length > 1 && (
            <button
              ...
              className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/25 text-white transition-colors cursor-pointer"
            >
          ...
          {photos.length > 1 && (
            <button
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/25 text-white transition-colors cursor-pointer"
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          {/* Label */}
          <span className="absolute bottom-5 left-1/2 -translate-x-1/2 text-white/40 text-xs font-medium">
            {label} — Foto {lightboxIndex + 1}
          </span>
        </div>
      )}
    </>
